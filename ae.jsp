...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
            ...
            <a href="ae.jsp" class="nav-item nav-link active">Add Engineer</a>
    ...
    <form action="aeact.jsp" method="POST">
        <div class="mb-3">
        ...
        PreparedStatement pst=co.prepareStatement("select * from engineer ");
    ...
    <tbody>
      ...
      <tr>
       ...
       <td><%=rs.getString(3)%></td>
        ...
        <td>
            <a href="aedel.jsp?username=<%=rs.getString(1)%>&email=<%=rs.getString(3)%>"><button class="btn btn-primary btn-sm">Delete</button></a>
