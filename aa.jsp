...
<html lang="en">
  ...
  <body>
      ...
      >
        ...
        >
           <div class="navbar-nav font-weight-bold mx-auto py-0">
            ...
            <a href="as.jsp" class="nav-item nav-link">add Supervisor</a>
            <a href="aa.jsp" class="nav-item nav-link active">Add Authority</a>
    ...
    <form action="aaact.jsp" method="POST">
        <div class="mb-3">
        ...
        PreparedStatement pst=co.prepareStatement("select * from hauthority ");
  ...
  <h4 class="text-center mb-4">View Authority</h4>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td><%=rs.getString(3)%></td>
        ...
        <td>
            <a href="aadel.jsp?username=<%=rs.getString(1)%>&email=<%=rs.getString(3)%>"><button class="btn btn-primary btn-sm">Delete</button></a>
