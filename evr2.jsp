...
// Output the hash
        ...
        PreparedStatement pst2=co.prepareStatement("insert into engineer_data(did,fdata,amount,bckey,username,namount,nkey,person) values(?,?,?,?,?,?,?,?)");
	...
	pst2.setString(2,fdata);
	 ...
	 pst2.executeUpdate();
        ...
        PreparedStatement pst3=co.prepareStatement("update contractor_report set namount='"+amount+"',nkey='"+bckey+"',person='"+username+"' where did='"+did+"' ");
      int i= pst3.executeUpdate();
      if(i>0){
       response.sendRedirect("evr.jsp?m1=registration_success"); 
      }
      else{
          response.sendRedirect("evr.jsp?m2=registration_failed"); 
      }
       }
