...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
            ...
            <a href="af.jsp" class="nav-item nav-link active">Add Finance</a>
    ...
    <form action="afact.jsp" method="POST">
        <div class="mb-3">
        ...
        PreparedStatement pst=co.prepareStatement("select * from finance ");
    ...
    <tbody>
      ...
      <tr>
       ...
       <td><%=rs.getString(3)%></td>
        ...
        <td>
            <a href="afdel.jsp?username=<%=rs.getString(1)%>&email=<%=rs.getString(3)%>"><button class="btn btn-primary btn-sm">Delete</button></a>
